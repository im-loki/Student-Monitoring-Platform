...
<body>
	...
	<div class="container">
		<div class="row"><div class="col-md-6"><h2>(Attendance)Data Entered successfully.</h2></div></div>
			<div class="row text-center" style="
			display: inline-flex; ">
				<div class="col-md-6">
				<img src="./stylesheets/atten.jpg" class="img-responsive" data-toggle="modal" data-target="#project1">
				<h3>Add more Attendance Enteries.</h3>
